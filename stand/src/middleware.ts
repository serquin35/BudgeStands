...
export async function updateSession(request: NextRequest) {
  ...
  // Si hay usuario y está en /login o /, redirigir al dashboard
...
export const config = {
  matcher: [
     ...
     * - api/ (nuestro api handler para n8n)
     * - todos los archivos con extensiones (svg, png, etc.)
     */
